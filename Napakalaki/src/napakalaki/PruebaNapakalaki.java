...
public class PruebaNapakalaki {
    ...
    public static void main(String[] args) {
        ...
        badConsequence = new BadConsequence("La quinta directiva primaria te obliga a perder 2 niveles y un tesoro 2 manos visibles", 2, new ArrayList(Arrays.asList(TreasureKind.BOTHHANDS)), null);
        prize = new Prize(2, 1);
        ...
        badConsequence = new BadConsequence("Te faltan manos para tanta cabeza. Pierdes 3 niveles y tus tesoros visibles de las manos", 3, new ArrayList(Arrays.asList(TreasureKind.BOTHHANDS)), null); //Preguntar por los tesoros
        prize = new Prize(2, 1);
